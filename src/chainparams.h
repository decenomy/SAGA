...
#define PORT_MAINNET 37552
#define PORT_TESTNET 47552
#define PORT_REGTEST 57552
 ...
 * CryptoSaga system. There are three: the main network on which people trade goods
